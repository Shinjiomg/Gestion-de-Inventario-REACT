    ...
    return (
            <div className='navbar border-solid border-black border ml-16 mt-16 mb-16'>
                ...
                <div className='inventario flex flex-col pb-4'>
                    ...
                    <Link to='/statistics' className='nextButton uppercase pl-5 pt-2.5 pb-2.5 bg-transparent flex justify-start rounded-none'>{statisticsIcon}estadisticas</Link>
                    <Link to='/manage-inventory' className='nextButton uppercase pl-5 pt-2.5 pb-2.5 bg-transparent flex justify-start rounded-none'>{statisticsIcon}gestionar inventario</Link>
                </div>
